...
const CBIBenefits: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#FAF8F5', padding: '8rem 2rem', color: '#1A2744' }}>
        ...
        <div style={{ 
          ...
          {benefits.map((item, index) => (
            <motion.div
              ...
              // Add hover styles logic via CSS in generic stylesheet or inline logic if complex
              onMouseEnter={(e) => {
            ...
            >
              ...
              <div style={{ marginTop: 'auto', paddingTop: '1rem', color: 'var(--color-gold-imperial)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', cursor: 'pointer' }}>
